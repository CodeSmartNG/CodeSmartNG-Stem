...
function App() {
  ...
  const renderView = () => {
    ...
    switch(currentView) {
      ...
      default:
        // Continue with role-specific views
        break;
    }
    ...
    if (isStudent) {
      switch(currentView) {
        ...
        case 'courses':
          return <CourseCatalog student={currentUser} setStudent={updateStudentData} />;
        case 'discussion':
          return <DiscussionForum currentUser={currentUser} />;
        case 'dashboard':
        default:
          return <Dashboard student={currentUser} setStudent={updateStudentData} />;
      }
    }
